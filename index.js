/*** SET THESE VARIABLES ***/
const contractAddress = "0x9c740b64571fd42494F754718ce7dc50924928e9"; // Update with the address of your smart contract
const contractAbi = "./sampleAbi.json"; // Update with an ABI file, for example "./sampleAbi.json"
